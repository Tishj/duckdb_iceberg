...
public:
	...
	static optional<string> TryFromJSON(yyjson_val *obj, AddEncryptionKeyUpdateBuilder &builder);
...
public:
	...
	optional<string> TryBuild(optional<AddEncryptionKeyUpdate> &result);
