...
public:
	...
	static optional<string> TryFromJSON(yyjson_val *obj, RemovePartitionStatisticsUpdateBuilder &builder);
...
public:
	...
	optional<string> TryBuild(optional<RemovePartitionStatisticsUpdate> &result);
