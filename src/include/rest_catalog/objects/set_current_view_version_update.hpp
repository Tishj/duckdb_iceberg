...
public:
	...
	static optional<string> TryFromJSON(yyjson_val *obj, SetCurrentViewVersionUpdateBuilder &builder);
...
public:
	...
	optional<string> TryBuild(optional<SetCurrentViewVersionUpdate> &result);
