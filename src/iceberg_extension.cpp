...
static void LoadInternal(ExtensionLoader &loader) {
	...
	config.AddExtensionOption(
	    ...
	    "DANGEROUS COMPATIBILITY SETTING: interpret a null Iceberg STRUCT default as an empty struct whose fields "
	    "use their own defaults. The only non-null value accepted is '{}'. Configure before loading Iceberg schemas.",
